...
- [x] 3.3 Keep App-owned runtime checks tied to the actual owner of `stepGame`, skill event consumption, mutable runtime refs, and playable battle-loop behavior.
- [x] 3.4 Run `npm test` after the smoke-test boundary update and confirm the checks still protect equivalent behavior.
...
- [x] 6.6 Review the final diff to confirm no gameplay runtime, skill runtime, save schema, storage key, copy, CSS, backend, dependency, or skill-editor acceptance changes were introduced.
