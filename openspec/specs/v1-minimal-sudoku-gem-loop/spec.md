...
#### Scenario: Behavior support reaches playable frontend runtime
...
- **THEN** the tests SHALL verify the effect through frontend-owned playable runtime paths, including emitted events, timing, targets, damage, status, buffs, or player/monster state as applicable.
...
The system SHALL keep gem matrix verification on playable frontend runtime paths and SHALL NOT use disabled tooling surfaces as proof.
